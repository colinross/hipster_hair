...
class StylesControllerTest < ActionController::TestCase
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post :create, style: { description: @style.description, photo_url: @style.photo_url, title: @style.title }
    end
  ...
  test "should update style" do
    patch :update, id: @style, style: { description: @style.description, photo_url: @style.photo_url, title: @style.title }
    assert_redirected_to style_path(assigns(:style))
  end
